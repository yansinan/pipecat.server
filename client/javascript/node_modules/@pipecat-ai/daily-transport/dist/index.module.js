...
import {logger as $7zbD8$logger, DeviceError as $7zbD8$DeviceError, RTVIError as $7zbD8$RTVIError, TransportStartError as $7zbD8$TransportStartError, RTVIMessage as $7zbD8$RTVIMessage, MessageTooLargeError as $7zbD8$MessageTooLargeError, Transport as $7zbD8$Transport} from "@pipecat-ai/client-js";
...
class $683f111f61e07358$export$b1ca982aa1e488c1 extends (0, $7zbD8$Transport) {
    ...
    enableMic(enable) {
        ...
        if (this._daily.participants()?.local) this._daily.setLocalAudio(enable);
    }
    get isMicEnabled() {
    ...
    enableCam(enable) {
        ...
        if (this._daily.participants()?.local) this._daily.setLocalVideo(enable);
    }
    get isCamEnabled() {
    ...
    async _connect(connectParams) {
        ...
        this._maxMessageSize = r?.domainConfig?.max_app_message_size || 10485760;
    ...
    sendMessage(message) {
        try {
            ...
            if (error instanceof Error && error.message.includes("Message data too large")) throw new (0, $7zbD8$MessageTooLargeError)(error.message);
            throw error;
        }
    }
    handleAppMessage(ev) {
