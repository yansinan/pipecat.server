import {DeviceError as $99wTV$DeviceError, logger as $99wTV$logger, isAPIRequest as $99wTV$isAPIRequest, RTVIError as $99wTV$RTVIError, TransportStartError as $99wTV$TransportStartError, RTVIMessage as $99wTV$RTVIMessage, messageSizeWithinLimit as $99wTV$messageSizeWithinLimit, MessageTooLargeError as $99wTV$MessageTooLargeError, makeRequest as $99wTV$makeRequest, UnsupportedFeatureError as $99wTV$UnsupportedFeatureError, Transport as $99wTV$Transport} from "@pipecat-ai/client-js";
...
class $b31644dc78dca54a$export$62043589d053a879 extends (0, $99wTV$Transport) {
    ...
    sendMessage(message) {
        ...
        if (!(0, $99wTV$messageSizeWithinLimit)(message, this._maxMessageSize)) throw new (0, $99wTV$MessageTooLargeError)("Message data too large. Max size is " + this._maxMessageSize);
    ...
    createPeerConnection() {
        ...
        pc.addEventListener("icegatheringstatechange", ()=>{
            if (pc.iceGatheringState === "complete" && pc.iceConnectionState === "checking" && this._waitForICEGathering) {
                (0, $99wTV$logger).info("Ice gathering completed and connection is still checking. Trying to reconnect.");
    ...
    async negotiate(recreatePeerConnection = false) {
        ...
        try {
            ...
            if (typeof Request !== "undefined" && this._webrtcRequest.endpoint instanceof Request) request = {
                ...
                request = (0, $99wTV$lodashcloneDeep)(this._webrtcRequest);
...
const $b31644dc78dca54a$var$botParticipant = (pc_id)=>({
        id: pc_id || "bot",
        local: false,
        name: "bot"
    });
